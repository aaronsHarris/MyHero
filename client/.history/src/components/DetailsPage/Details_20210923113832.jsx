...
export const Details = () => {
  ...
  return (
    <div className="w-screen h-screen bg-tavern p-3 overflow-y-auto grid grid-col-3 grid-row-3">
      <div className="container bg-red-500  h-56 w-56"></div>
      <div className="container bg-blue-500  h-56 w-56"></div>
      <div className="container bg-green-500  h-56 w-56"></div>
      <div className="container bg-yellow-500  h-56 w-56"></div>
    </div>
  )
}
