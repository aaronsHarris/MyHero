...
export const Details = () => {
  ...
  return (
    <div className="min-w-screen min-h-screen bg-tavern overflow-y-auto flex justify-center items-center">
      <div className="grid grid-cols-3 md:grid-cols-2 lggrid-rows-3 gap-2">
        <div className="container bg-red-500  h-56 w-56 p-3">1</div>
        <div className="container bg-blue-500  h-56 w-56 p-3">2</div>
        <div className="container bg-green-500  h-56 w-56 p-3">3</div>
        <div className="container bg-yellow-500  h-56 w-56 p-3">4</div>
        <div className="container bg-black  h-56 w-56 p-3">5</div>
      </div>
    </div>
  )
}
