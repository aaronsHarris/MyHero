...
export const Details = () => {
  ...
  return (
    <div className="min-w-screen min-h-screen bg-tavern overflow-y-auto flex justify-center items-center">
      <div className="grid grid-cols-1 grid-rows-0 gap-2 md:grid-cols-2 lg:grid-cols-3 rows-3">
        <div className="container bg-red-500 p-3 row-span-2"> <img className="rounded-lg shadow-lg antialiased bg-yellow-500" src={heroes.fields?.avatar} /></div>
        <div className="container bg-blue-500 p-3 col-span-2">2</div>
        <div className="container bg-green-500 p-3">3</div>
        <div className="container bg-yellow-500  p-3">4</div>
        <div className=" bg-black col-span-3 px-3"><DetailTitles
                title="Info"
