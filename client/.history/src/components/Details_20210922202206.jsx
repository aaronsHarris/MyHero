...
export const Details = () => {
  ...
  <div class="card-body">
    ...
    <p>Rerum reiciendis beatae tenetur excepturifle aut pariatur est eos. Sit sit necessitatibus veritatis sed molestiae voluptates incidunt iure sapiente.</p> 
