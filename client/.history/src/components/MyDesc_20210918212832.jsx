...
export const MyDesc = (props) => {
  ...
  return (
    <div class="sm:flex justify-center items-center h-screen w-full bg-parchment lg:bg-no-repeat bg-center">
    <div class="w-1/2 card glass rounded-lg shadow-2xl p-8 m-4">
