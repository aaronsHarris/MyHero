...
const Hero = () => {
  return (
    <div className="conatiner">
      <div className="sm:hero flex min-h-screen w-width bg-base-200 bg-dragon lg:bg-no-repeat bg-cover justify-center">
        <div className="text-center hero-content card glass m-auto">
