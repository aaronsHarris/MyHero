  ...
  return (
    <div className="min-w-screen min-h-screen bg-dragon bg-no-repeat  bg-cover overflow-y-auto flex justify-center">
      <div className="sm:grid grid-cols-1 gap-2 lg:grid-cols-2 row-2">
        <div className="p-4 bg-red-400 col-span-2"><h1 className="lg:text-8xl md:text-7xl sm:text-5xl text-3xl font-black my-14 bg-clip-text">Welcome Hero
          </h1></div>
        <div className="p-4 bg-blue-400 col-span-2 max-w-screen-md"><p className="mb-28 text-2xl">
        ...
        <div className="p-4 bg-yellow-400"><div className="grid flex-grow h-32 card glass rounded-box place-items-center">
              <Link to="/Tavern">
                <button className="btn glass">The Tavern</button>
              </Link>
            </div></div>
        <div className="p-4 bg-green-400"><div className="grid flex-grow h-32 card glass rounded-box place-items-center">
              <Link to="/Tavern">
                <button className="btn glass">The Tavern</button>
              </Link>
            </div></div>
