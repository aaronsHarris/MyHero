        ...
        <div class="rounded-lg shadow-lg  w-full flex flex-row flex-wrap p-3 antialiased">
          ...
          <div class="md:w-2/3 w-full px-3 flex flex-row flex-wrap">
            <div class="w-full text-center  font-semibold relative pt-3 md:pt-0">
              ...
              <button className="btn glass "><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16l-4-4m0 0l4-4m-4 4h18" /></svg></button>
            </div>
          </div>
        </div>
