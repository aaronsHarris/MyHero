...
export const Details = (props) => {
  ...
  if (heroes === null) {
    ...
    return (
      <div className=" sm:min-h-screen w-screen flex flex-col justify-top items-center bg-tavern bg-cover overflow-y-auto lg:bg-no-repeat min-h-screen mb-auto bg-center motion-safe:hover:scale-110">
