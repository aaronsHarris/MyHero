  ...
  return (
    <div className="conatiner">
      <div className="sm:hero flex min-h-screen w-screen bg-base-200 bg-dragon lg:bg-no-repeat bg-cover justify-center">
        <div className="max-w-md font-sans relative">
          <h1 className="lg:text-9xl md:text-7xl sm:text-5xl text-3xl font-black mb-14 bg-clip-text absolute">Welcome Hero
          </h1>
          <p className="mb-5">
