        ...
        <div class="rounded-lg shadow-lg  w-full flex flex-row flex-wrap p-3 antialiased">
          ...
          <div class="md:w-2/3 w-full px-3 flex flex-row flex-wrap">
            <div class="w-full text-center  font-semibold relative pt-3 md:pt-0">
              ...
              <h3 className="lg:text-4xl md:text-7xl sm:text-5xl mb-6">"{heroes.fields?.quote}"</h3>
              ...
              <h3 className=" text-lg mb-4">{heroes.fields?.race}</h3>
              ...
              <p className="mx-1 overflow-ellipsis text-lg">{heroes.fields?.info}</p>
