...
export const Details = (props) => {
  ...
  if (heroes === null) {
    ...
    return (
      <div className=" sm:min-h-screen w-screen flex flex-wrap justify-top items-center bg-tavern bg-cover overflow-y-auto lg:bg-no-repeat min-h-screen mb-auto bg-center ">
        <h1 className="lg:text-9xl md:text-7xl sm:text-5xl text-3xl font-black mb-14 text-white order-10">
          The Tavern
        </h1>
        {heroes.map((hero) => {
          return (
            ...
            <div className="card lg:card-side bordered m-6">
              <img className="max h-40"src={hero.fields?.avatar} />
              <div className="card-body">
                <h2 className="card-title">{hero.fields?.name}</h2>
                <h3 className="card-title">{hero.fields?.title}</h3>
