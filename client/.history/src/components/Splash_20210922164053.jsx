  ...
  return (
    <div className="conatiner">
      <div className="sm:hero flex min-h-screen w-screen bg-base-200 bg-dragon lg:bg-no-repeat bg-cover justify-center">
        <div className="max-w-md font-sans text-black">
          <h1 className="lg:text-7xl md:text-7xl sm:text-5xl text-3xl font-black my-14 bg-clip-text">Welcome Hero
          </h1>
          ...
          <div class="sm:flex flex-col w-full lg:flex-row">
            <div class="grid flex-grow h-32 card glass rounded-box place-items-center"><Link to="/new">
              <button className="btn glass">Create a Hero!</button>
            </Link></div>
            <div class="divider lg:divider-vertical">OR</div>
            <div class="grid flex-grow h-32 card glass rounded-box place-items-center"><Link to="/Tavern">
              <button className="btn glass">The Tavern</button>
            </Link></div>
          </div>
        </div>
