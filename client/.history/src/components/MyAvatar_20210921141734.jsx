...
export const MyAvatar = (props) => {
  ...
  return (
    <div className="sm:h-screen w-screen flex flex-wrap justify-around items-center bg-avatar bg-cover overflow-y-auto">
      ...
      <AvatarCard bg="card bg-riz bg-no-repeat bg-cover h-64 w-64 lg:card-side text-neutral-content" title="Geeky" value="c" handleClick={handleClick} />

      <AvatarCard bg="card bg-aguefort bg-no-repeat bg-cover h-64 w-64 lg:card-side text-neutral-content" title="Classy" value="d" handleClick={handleClick} />
      
      <AvatarCard bg="card bg-riz bg-no-repeat bg-cover h-64 w-64 lg:card-side text-neutral-content" title="Geeky" value="e" handleClick={handleClick} />
