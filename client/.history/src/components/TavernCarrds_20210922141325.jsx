      ...
      <div className=" sm:min-h-screen w-screen flex flex-col justify-top items-center bg-tavern bg-cover overflow-y-auto lg:bg-no-repeat min-h-screen mb-auto bg-center">
        {heroes.map((hero) => {
          return (
            ...
            <div className="sm:card justify-center justify-align-center lg:card-side bordered m-6 max-w-screen-sm">
              <img className="sm:max-w-sm h-64" src={hero.fields?.avatar} alt="avatars" />
