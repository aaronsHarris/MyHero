...
<div class="rounded-lg shadow-lg bg-gray-600 w-full flex flex-row flex-wrap p-3 antialiased">
  ...
  <div class="md:w-2/3 w-full px-3 flex flex-row flex-wrap">
    <div class="w-full text-left text-gray-700 font-semibold relative pt-3 md:pt-0">
              <div class="text-2xl text-white leading-tight">{heroes.fields?.name}</div>
              <h2 class="card-title text-7xl mb-2">{heroes.fields?.name}</h2>
              <div class="text-normal text-gray-300 hover:text-gray-400 cursor-pointer"><span class="border-b border-dashed border-gray-500 pb-1">{heroes.fields?.title}</span></div>
