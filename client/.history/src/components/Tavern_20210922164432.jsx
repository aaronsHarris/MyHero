...
export const Tavern = () => {
  ...
  return (
    <div className=" sm:min-h-screen w-screen flex flex-col justify- items-center bg-tavern bg-cover overflow-y-auto bg-no-repeat lg:bg-no-repeat min-h-screen mb-auto">
