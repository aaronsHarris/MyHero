...
export const TavernCarrds = (props) => {
  const { heroes } = props
  const [showMsetShowMore] = useState(false)
  ...
  if (heroes === null) {
    ...
    return (
      ...
      <div className=" sm:min-h-screen w-screen flex flex-col justify-top items-center bg-tavern bg-cover overflow-y-auto lg:bg-no-repeat min-h-screen mb-auto bg-center">
        <div className=" sm:min-h-screen w-screen flex flex-col justify-center items-center bg-cover overflow-y-auto bg-no-repeat lg:bg-no-repeat min-h-screen mb-auto">
