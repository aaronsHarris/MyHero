...
export const Details = () => {
  ...
  return (
    <div className="sm: hh-screen w-screen flex flex-row justify-center items-center bg-tavern overflow-y-hidden">
      <div className="card lg:card-side bordered bordered w-2/6 h-5/6 justify-center"><figure>
        <img className="h-full" src={heroes.fields?.avatar}  />
      </figure></div>
