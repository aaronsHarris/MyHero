...
export const Details = () => {
  ...
  return (
    <div class="sm: justify-center card h-screen w-screen image-full bg-tavern bg-center  bg-no-repeat overflow-y-auto">
      <figure>
      ...
      <div class="justify-center card-body max-w-md m-auto">
        ...
        <div class="divider m-0"></div> 
          ...
          <div class="divider m-0"></div> 
          <h3 className="sm:text-2xl mb-4 font-serif">Class</h3>
          <h3>{heroes.fields?.classes}</h3>
          <div class="divider m-0"></div> 
          <h3 className="sm:text-2xl mb-4 font-serif">Weapon</h3>
          <h3>{heroes.fields?.weapon}</h3>
          <div class="divider m-0"></div> 
          <h3 className="sm:text-2xl mb-4 font-serif">Armor</h3>
