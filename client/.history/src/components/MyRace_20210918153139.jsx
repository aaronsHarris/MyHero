...
export const MyRace = (props) => {
  ...
  return (
    <div className="h-screen w-screen flex flex-wrap justify-around items-center">
        ...
        <div class="card glass lg:card-side text-neutral-content">
          <div class="max-w-md card-body">
            ...
            <div class="card-actions">
              <button class="btn glass rounded-lg" onClick={(e) => handleClick(e)} value="elf">This One~!</button>
            </div>
          </div>
        </div>
      </div>
