...
export const MyRace = (props) => {
  ...
  return (
    <div className="h-screen w-screen flex flex-wrap justify-around items-center bg-dovekin">
      <div class="flex items-center px-4 py-10 bg-cover card bg-base-200 m-1 bg-forest">
