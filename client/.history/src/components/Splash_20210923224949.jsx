...
const Hero = () => {
  return (
    <div className="min-w-screen min-h-screen bg-dragon bg-no-repeat  bg-cover overflow-y-auto flex justify-center items-center">
      <div className="sm:grid grid-cols-1 gap-2 lg:grid-cols-3 ">
        <div className="p-4 bg-red-400">Welcomz</div>
        <div className="p-4 bg-blue-400">Description</div>
        <div className="p-4 bg-yellow-400">Welcomz</div>
        <div className="p-4 bg-green-400">Welcomz</div>
