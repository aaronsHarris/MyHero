    ...
    <div className="conatiner">
      <div className="sm:hero flex min-h-screen w-screen bg-base-200 bg-dragon lg:bg-no-repeat bg-cover justify-center">
        <div className="max-w-md font-sans text-center">
          ...
          <div className="sm:flex flex-col justify-center items-center w-full lg:flex-row">
            <div className=""><Link to="/new">
              <button className="grid flex-grow h-32 card glass rounded-box place-items-center text-2xl">Create a Hero!</button>
            </Link>
            </div>
