...
const Hero = () => {
  return (
    <div className="conatiner">
      ...
      <h1 className="lg:text-9xl md:text-7xl sm:text-5xl text-3xl font-black mb-14 bg-clip-text text-transparent bg-gradient-to-r from-black to-green-300">The Tavern
    </h1>
            <p className="mb-5">
