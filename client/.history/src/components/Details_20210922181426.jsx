...
export const Details = () => {
  ...
  return (
    <div class="sm:justify-center card h-screen w-screen bg-tavern bg-cover  bg-no-repeat overflow-y-auto lg:">
      <figure>
        <img src={heroes.fields?.avatar} className="image-full" />
      </figure>
