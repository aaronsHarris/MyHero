...
const Hero = () => {
  return (
    <div className="conatiner">
      ...
      <h1 className="lg:text-9xl md:text-7xl sm:text-5xl text-3xl font-black mb-14 bg-clip-text">The Tavern
    </h1>
            <p className="mb-5">
  ...
  <div class="sm:grid flex-grow h-32 card bg-base-300 rounded-box place-items-center">content</div> 
  <div class="divider lg:divider-vertical">OR</div> 
