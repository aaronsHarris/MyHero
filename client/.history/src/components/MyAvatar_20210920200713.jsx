  ...
  return (
    <div className="sm:h-screen w-screen flex flex-wrap justify-around items-center bg-avatar bg-cover overflow-y-auto">
      ...
      <div className="flex flex-col items-center px-4 py-10 m-1">
        <h1 className="card-title text-white text-2xl">Tough</h1>
      ...
      <div className="flex flex-col items-center px-4 py-10 m-1">
        <h1 className="card-title text-white text-2xl">Brave</h1>
        <div className="card bg-elfLady bg-no-repeat bg-cover h-64 w-64 lg:card-side text-neutral-content">
          <div className="max-w-md card-body">
            <div className="card-actions items-center justify-center">
            </div>
          </div>
      ...
      <div className="flex flex-col items-center px-4 py-10 m-1">
        <h1 className="card-title text-white text-2xl">Cham</h1>
