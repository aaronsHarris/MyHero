  ...
  return (
    <div class="sm: justify-center card h-screen w-screen image-full bg-tavern overflow-y-auto">
      ...
      <div class="justify-center card-body max-w-md m-auto">
        <h2 class="card-title text-7xl mb-10">{heroes.fields?.name}</h2>
        ...
        <div className="">
          ...
          <h3>{heroes.fields?.alignment}</h3>
          <div class="divider m-0"></div> 
          <h2 className="sm:text-xl">Description</h2>
          <div class="divider m-0"></div> 
          <p className="mb-5 overflow-ellipsis border rounded-lg">{heroes.fields?.info}</p>
          <Link to="/Tavern">
